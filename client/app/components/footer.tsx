        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-blue-200">
              Email: <a href="mailto:kelvinkayoi@gmail.com" className="hover:underline">kelvinkayoi@gmail.com</a>
            </p>
            <p className="text-blue-200">
              Phone: <a href="tel:+254703649833" className="hover:underline">+254 703 649833</a>
            </p>
            <div className="mt-4">
