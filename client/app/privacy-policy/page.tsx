  ...
  return (
    <main className="bg-gradient-to-b from-blue-50 to-white min-h-screen">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8 text-center text-blue-800">Privacy Policy</h1>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">2. Data We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">3. How We Use Your Data</h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">4. Data Storage and Security</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">5. Data Deletion/Modification</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">6. Changes to This Privacy Policy</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">7. Contact Us</h2>
              <p className="text-gray-700 leading-relaxed">
